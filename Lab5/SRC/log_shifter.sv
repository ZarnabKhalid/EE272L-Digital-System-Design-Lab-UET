module log_shifter (
    ...
    mux2to1 m0 (.sel(s[1]), .d0(x[0]), .d1(1'b0), .y(stage1[0]));
    mux2to1 m1 (.sel(s[1]), .d0(x[1]), .d1(1'b0), .y(stage1[1]));
    mux2to1 m2 (.sel(s[1]), .d0(x[2]), .d1(x[0]), .y(stage1[2]));
    mux2to1 m3 (.sel(s[1]), .d0(x[3]), .d1(x[1]), .y(stage1[3]));
